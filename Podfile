...
post_install do |installer|
  ...
  if Dir.exists?('GameStore/Resources/Settings.bundle') && File.exists?(acknowledgements_plist)
    FileUtils.cp(acknowledgements_plist, 'GameStore/Resources/Settings.bundle/Acknowledgements.plist')
  end
end
